...
* Запазено право: 2012-2022 г. NV Access ООД, Noelia Ruiz Martínez
...
Освен това можете да настроите символите да изпращат и да изчистват точките,
когато пишете с една ръка.
